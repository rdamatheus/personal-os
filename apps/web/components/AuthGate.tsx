...
export default function AuthGate({ children }: { children: ReactNode }) {
  ...
  return <IdentityContext.Provider value={identity}>
    ...
    <div style={{position:'fixed',right:18,bottom:18,zIndex:80,display:'flex',gap:8,alignItems:'center',flexWrap:'wrap',justifyContent:'flex-end'}}>
      ...
      <Link href="/jornadas/" aria-label="Abrir Jornadas e Progressão" style={{textDecoration:'none',border:'1px solid #5874ad',background:'#1a2740',color:'#f1f5ff',borderRadius:999,padding:'11px 14px',fontSize:13,fontWeight:800,boxShadow:'0 14px 40px rgba(0,0,0,.3)'}}>◆ Jornadas</Link>
      <Link href="/organizar/" aria-label="Abrir núcleo operacional" style={{textDecoration:'none',border:'1px solid #4a5f82',background:'#182235',color:'#eef3ff',borderRadius:999,padding:'11px 14px',fontSize:13,fontWeight:800,boxShadow:'0 14px 40px rgba(0,0,0,.25)'}}>✓ Organizar</Link>
