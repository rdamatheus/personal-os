...
export default function AuthGate({ children }: { children: ReactNode }) {
  ...
  return <IdentityContext.Provider value={identity}>
    ...
    <div style={{position:'fixed',right:18,bottom:18,zIndex:80,display:'flex',gap:8,alignItems:'center',flexWrap:'wrap',justifyContent:'flex-end'}}>
      ...
      <Link href="/routes/" aria-label="Abrir Metas e Rotas" style={{textDecoration:'none',border:'1px solid #31405a',background:'#111824',color:'#c9d7f7',borderRadius:999,padding:'11px 14px',fontSize:13,fontWeight:800,boxShadow:'0 14px 40px rgba(0,0,0,.25)'}}>◎ Metas e rotas</Link>
